@extends('backend.layout.master', ['title' => 'Edit Pamong']);
@section('content')
        ...
        <div class="section-body">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{Route('pamong.update',$data->id)}}"  method="post">
                                @csrf
                                @method("PUT")
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{$data->asal_sekolah}}" name="asal_sekolah" placeholder="Sekolah" id="sekolah" class="form-control">
                                </div>
                                <div class="form-group">
