@extends('backend.layout.master', ['title' => 'Master Pamong']);
@section('content')
                                    ...
                                    <tbody>
                                        @foreach ($data as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="{{Route('pamong.destroy',$item->id)}}" method="post">
                                                        @csrf
                                                        @method("DELETE")
                                                        ...
                                                        <a href="{{Route('pamong.edit',$item->uuid)}}" class="btn btn-warning">Edit</a>
                                                    </form>
                                                </td>
                                            </tr>
                                        @endforeach
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{Route('pamong.store')}}"  method="post">
                            @csrf
                            @method("POST")
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{old('asal_sekolah')}}" name="asal_sekolah" placeholder="Sekolah" id="sekolah" class="form-control">
                            </div>
                            <div class="form-group">
