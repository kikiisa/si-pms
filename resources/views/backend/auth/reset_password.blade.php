                ...
                <div class="row">
                    <div
                        ...
                        <div class="card card-primary" style="margin-top: 30px">
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{Route('passwordReset')}}" class="needs-validation"
                                    novalidate="">
                                    @method("post")
                                    @csrf
                                    <div class="form-group">
                                        <input type="email" name="email" hidden value="{{request()->get('email')}}" class="form-control" placeholder="Email">
